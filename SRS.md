...
| ![enter image description here] Pada Register,  user yang tidak memiliki akun maka diminta untuk mengisi username, email, dan password.| ![enter image description here](https://github.com/Montisma/Sistem-Pengelolaan-Laundry/blob/e5e9e94ba033d8985ef9f8d0b41f292291bb192e/Image/FigmaREGIS.png)) Pada halaman user, terdapat Wash Your Clothes yang menampilkan cucian dan harga cucian, kemudian washing status yang menampilkan status pencucian.|
